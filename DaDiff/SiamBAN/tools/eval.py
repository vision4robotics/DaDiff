...
from toolkit.datasets import UAVDataset, UAVDARK70Dataset, NATDataset, NAT_LDataset,NUT_LDataset
from toolkit.evaluation import OPEBenchmark


parser = argparse.ArgumentParser(description='tracking evaluation')
parser.add_argument('--tracker_path', '-p', type=str, default='/mnt/sdd/user_backup/ZHB/results_315', # './results', './hp_search_results/checkpoint_e17'
                    help='tracker result path')
parser.add_argument('--dataset', '-d', type=str, default='NUT_L',  # UAVDark70, NAT_L #NAT #NUT_L
                    help='dataset name')
...
def main():
    ...
    #                         '../testing_dataset'))
    root = '/mnt/sdb/Test_dataset/NUT-L_folder' #'/mnt/sdg/Test_dataset/' #/mnt/sdb/Test_dataset/NAT2021_test' #/mnt/sdb/Test_dataset/NUT-L_folder
