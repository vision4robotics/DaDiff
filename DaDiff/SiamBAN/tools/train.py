...
from siamban.utils.model_load import load_pretrain, restore_from, load_pretrain_diff
...
def train(source_loader, target_loader, model, optimizer, lr_scheduler, Disc, optimizer_D):
...
def main():
    ...
    #load_pretrain_diff(model.diffusion, '/home/user/V4R/ZHB/UDAT-main/ddim/exp/logs_condition_all/ddim/ckpt.pth')   
    ...
    # start training
    train(source_loader, target_loader, dist_model, optimizer, lr_scheduler, dist_Disc, optimizer_D)
