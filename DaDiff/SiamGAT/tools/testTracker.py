...
parser.add_argument('--dataset', type=str, default='NUT_L', #NAT #UAVDark70 #NUT_L
        help='datasets') # OTB100 LaSOT UAV123 GOT-10k
parser.add_argument('--vis', action='store_true', default=True,
        help='whether visualzie result')
parser.add_argument('--snapshot', type=str, default='/mnt/sdd/user_backup/ZHB/SiamGAT/snapshot_DDAM_240309/checkpoint_e45.pth', #48 #37
        help='snapshot of models to eval')
parser.add_argument('--config', type=str, default='/mnt/sdd/user_backup/ZHB/SiamGAT/experiments/siamgat_googlenet/config.yaml',
        help='config file')
...
def main():
    ...
    dataset_root = '/mnt/sdb/Test_dataset/NUT-L_folder' #os.path.join(cur_dir, 'test_dataset', args.dataset) #/mnt/sdb/Test_dataset/NAT2021_test/ #/mnt/sdg/Test_dataset/ #/mnt/sdb/Test_dataset/NUT-L_folder
